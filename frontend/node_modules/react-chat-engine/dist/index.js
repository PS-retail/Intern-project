...
function getOrCreateSession(props, callback) {
...
var Socket = function Socket(props) {
  ...
  var _useState3 = React.useState(Date.now() + minSocketLag),
  ...
  if (sessionToken === '') return /*#__PURE__*/React__default.createElement("div", null);
...
var ChatList = function ChatList(props) {
  ...
  React.useEffect(function () {
    if (!didMountRef.current) {
      didMountRef.current = true;
      reactChatEngine.getLatestChats(props, count, function (chats) {
        onGetChats(chats);
...
var ChatHeader = function ChatHeader() {
  ...
  if (!chat) {
    ...
    var dateTime = getDateTime(chat.last_message.created, conn.offset);
...
var SendingMessages = function SendingMessages(props) {
  ...
  return keys.map(function (key, index) {
    ...
    if (message && message.chat === activeChat) {
      ...
      }, props.renderSendingMessages ? props.renderSendingMessages(conn, chat, sendingMessages[lastMessageKey], message, sendingMessages[nextMessageKey]) : /*#__PURE__*/React__default.createElement(Message$1, {
        sending: true,
        chat: chat,
        message: message,
...
var ChatFeed = function ChatFeed(props) {
  ...
  var _useState2 = React.useState(false),
      hasFetchedMessages = _useState2[0],
      setHasFetchedMessages = _useState2[1];

  var _useState3 = React.useState(null),
      currentChat = _useState3[0],
      setCurrentChat = _useState3[1];
  ...
  function loadMessages(loadMoreMessages) {
    if (loadMoreMessages) {
      ...
      reactChatEngine.getLatestMessages(conn, activeChat, count$1, function (chatId, messages) {
      ...
      reactChatEngine.getLatestMessages(conn, props.activeChat, count$1, function (chatId, messages) {
        return onGetMessages(chatId, messages, "ce-feed-container");
      });
    }
  }
...
var ChatEngine = function ChatEngine(props) {
  ...
  }, props.renderChatList ? props.renderChatList(propsAndContext) : /*#__PURE__*/React__default.createElement(ChatList, propsAndContext)), /*#__PURE__*/React__default.createElement(reactGridSystem.Col, {
    xs: 12,
    sm: 6,
    style: {
      height: height ? height : ''
