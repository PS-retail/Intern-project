...
var ChatList = function ChatList(props) {
  ...
  useEffect(function () {
    if (!didMountRef.current) {
      didMountRef.current = true;
      getLatestChats$1(props, count, function (chats) {
        onGetChats(chats);
...
var SendingMessages = function SendingMessages(props) {
  ...
  return keys.map(function (key, index) {
    ...
    if (message && message.chat === activeChat) {
      ...
      }, props.renderSendingMessages ? props.renderSendingMessages(conn, chat, sendingMessages[lastMessageKey], message, sendingMessages[nextMessageKey]) : /*#__PURE__*/React.createElement(Message$1, {
        sending: true,
        chat: chat,
        message: message,
...
var ChatFeed = function ChatFeed(props) {
  ...
  function loadMessages(loadMoreMessages) {
    if (loadMoreMessages) {
      ...
      getLatestMessages$1(conn, activeChat, count$1, function (chatId, messages) {
      ...
      getLatestMessages$1(conn, props.activeChat, count$1, function (chatId, messages) {
        return onGetMessages(chatId, messages, "ce-feed-container");
      });
    }
  }
